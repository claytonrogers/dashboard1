...
servers = [{name: 'Google', url: 'http://www.google.com', method: 'http'},
		{name: 'Database', url: 'https://www.microsoft.com', method: 'http'},
		{name: 'Stable', url: 'www.google.com', method: 'ping'}]
